	...
	return (
		<section className={conteiner.section}>
			...
			<div className={conteiner.ingrediets}>
				<BurgerIngredientsType type='bun' name='Булки' data={data} />
				<BurgerIngredientsType type='sauce' name='Соусы' data={data} />
				<BurgerIngredientsType type='main' name='Начинки' data={data} />
			</div>
